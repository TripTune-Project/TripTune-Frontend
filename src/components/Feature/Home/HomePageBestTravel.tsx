  ...
  return (
    <>
      <div className={styles.recommendedDestinations}>
        ...
        <button className={styles.onBoardNoChooseBtn}>서울</button>
        <button className={styles.onBoardNoChooseBtn}>부산</button>
        <button className={styles.onBoardNoChooseBtn}>제주</button>
        <button className={styles.onBoardNoChooseBtn}>경기</button>
        <button className={styles.onBoardNoChooseBtn}>강원</button>
        <button className={styles.onBoardNoChooseBtn}>경상</button>
        <button className={styles.onBoardNoChooseBtn}>전라</button>
        <button className={styles.onBoardNoChooseBtn}>충청</button>
...
export default HomePageBestTravel;
